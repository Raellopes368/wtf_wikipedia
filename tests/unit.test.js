...
test('interwiki', t => {
  let str = 'hello [[wikinews:Radiohead]] world  [[Category:Films]]';
  let obj = wtf(str);
...
test('inline-templates', t => {
  let str = `hello {{ill|Article title|language code}} world {{Sfn|Rolling Stone|2004}}`;
  let have = wtf(str).plaintext();
